    ...
    return (
      ...
      <div className="grid max-w-screen-4xl px-20 mt-8  lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          ...
          <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
              <img src="src/assets/dog-2.png" alt="mockup"/>
          </div>

        {/* title */}
          <div className="ml-auto place-self-center lg:col-span-7">
              <h1 className="max-w-4xl mb-4 text-4xl font-extrabold tracking-widest leading-none md:text-8xl md:text-right xl:text-8xl sm:text-center dark:text-white">ABOUT US</h1>
