  ...
  return (
    ...
    <div className="grid max-w-screen-4xl px-20 mt-8  lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="max-w-4xl mb-4 text-4xl font-extrabold tracking-widest leading-none md:text-8xl md:text-start xl:text-8xl sm:text-center dark:text-white">WE ARE FLUFFU</h1>
