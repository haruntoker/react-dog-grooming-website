  ...
  return (
    ...
    <div className="grid max-w-screen-4xl px-20 mt-8  lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="max-w-4xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-8xl xl:text-8xl dark:text-white">WE ARE FLUFFU</h1>
            <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">One of the key features of Flufful is an individual approach to each dog. Groomers conduct a preliminary consultation with the owner to understand the characteristics and needs of a particular pet. This allows you to create the most comfortable and safe environment for the dog during the grooming
procedure.</p>
        ...
        <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
            <img src="src/assets/dog-header.png" alt="mockup"/>
        </div>                
    </div>
</section>
  )
