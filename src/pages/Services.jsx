...
import dogImg from "../assets/dog-4.png";

const Services = () => (
  <section className="bg-white dark:bg-gray-900">
    <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
      <img className="w-full dark:hidden" src={dogImg} alt="dashboard image" />
      <img className="w-full hidden dark:block" src={dogImg} alt="dashboard image" />
